...
| [FinSetsForCAP](https://homalg-project.github.io/pkg/FinSetsForCAP) | The (skeletal) elementary topos of finite sets | [![HTML stable documentation][html-FinSetsForCAP-img]][html-FinSetsForCAP-url] [![PDF stable documentation][pdf-FinSetsForCAP-img]][pdf-FinSetsForCAP-url] | [![Build Status][tests-FinSetsForCAP-img]][tests-FinSetsForCAP-url] | [![Code Coverage][codecov-FinSetsForCAP-img]][codecov-FinSetsForCAP-url] | dev |
| [FinGSetsForCAP](https://homalg-project.github.io/pkg/FinGSetsForCAP) | The (skeletal) elementary topos of finite G-sets | [![HTML stable documentation][html-FinGSetsForCAP-img]][html-FinGSetsForCAP-url] [![PDF stable documentation][pdf-FinGSetsForCAP-img]][pdf-FinGSetsForCAP-url] | [![Build Status][tests-FinGSetsForCAP-img]][tests-FinGSetsForCAP-url] | [![Code Coverage][codecov-FinGSetsForCAP-img]][codecov-FinGSetsForCAP-url] | dev |
...
| [GroupsAsCategoriesForCAP](https://homalg-project.github.io/pkg/GroupsAsCategoriesForCAP) | Groups as categories on one object | [![HTML stable documentation][html-GroupsAsCategoriesForCAP-img]][html-GroupsAsCategoriesForCAP-url] [![PDF stable documentation][pdf-GroupsAsCategoriesForCAP-img]][pdf-GroupsAsCategoriesForCAP-url] | [![Build Status][tests-GroupsAsCategoriesForCAP-img]][tests-GroupsAsCategoriesForCAP-url] | [![Code Coverage][codecov-GroupsAsCategoriesForCAP-img]][codecov-GroupsAsCategoriesForCAP-url] | dev |
...
| [MachineLearningForCAP](https://homalg-project.github.io/pkg/MachineLearningForCAP) | Gradient Based Learning via Category Theory | N/A | N/A | N/A | dev |
...
[html-AdditiveClosuresForCAP-img]: https://img.shields.io/badge/HTML-stable-blue.svg
[html-AdditiveClosuresForCAP-url]: https://homalg-project.github.io/CAP_project/AdditiveClosuresForCAP/doc/chap0_mj.html

[pdf-AdditiveClosuresForCAP-img]: https://img.shields.io/badge/PDF-stable-blue.svg
[pdf-AdditiveClosuresForCAP-url]: https://homalg-project.github.io/CAP_project/AdditiveClosuresForCAP/download_pdf.html

[tests-AdditiveClosuresForCAP-img]: https://github.com/homalg-project/CAP_project/actions/workflows/Tests.yml/badge.svg?branch=master
[tests-AdditiveClosuresForCAP-url]: https://github.com/homalg-project/CAP_project/actions/workflows/Tests.yml?query=branch%3Amaster

[codecov-AdditiveClosuresForCAP-img]: https://codecov.io/gh/homalg-project/CAP_project/branch/master/graph/badge.svg?flag=AdditiveClosuresForCAP
[codecov-AdditiveClosuresForCAP-url]: https://app.codecov.io/gh/homalg-project/CAP_project/tree/master/AdditiveClosuresForCAP
...
[html-GroupsAsCategoriesForCAP-img]: https://img.shields.io/badge/HTML-stable-blue.svg
[html-GroupsAsCategoriesForCAP-url]: https://homalg-project.github.io/CAP_project/GroupsAsCategoriesForCAP/doc/chap0_mj.html

[pdf-GroupsAsCategoriesForCAP-img]: https://img.shields.io/badge/PDF-stable-blue.svg
[pdf-GroupsAsCategoriesForCAP-url]: https://homalg-project.github.io/CAP_project/GroupsAsCategoriesForCAP/download_pdf.html

[tests-GroupsAsCategoriesForCAP-img]: https://github.com/homalg-project/CAP_project/actions/workflows/Tests.yml/badge.svg?branch=master
[tests-GroupsAsCategoriesForCAP-url]: https://github.com/homalg-project/CAP_project/actions/workflows/Tests.yml?query=branch%3Amaster

[codecov-GroupsAsCategoriesForCAP-img]: https://codecov.io/gh/homalg-project/CAP_project/branch/master/graph/badge.svg?flag=GroupsAsCategoriesForCAP
[codecov-GroupsAsCategoriesForCAP-url]: https://app.codecov.io/gh/homalg-project/CAP_project/tree/master/GroupsAsCategoriesForCAP
