...
[CAP][CAP] defines *and* allows defining [hierarchies](https://nbviewer.org/github/homalg-project/CategoricalTowers/blob/master/ToolsForCategoricalTowers/examples/julia/notebooks/DigraphOfKnownDoctrines.ipynb) of categorical [doctrines][doctrine], some of which are well-known, others are less known, or even new.
