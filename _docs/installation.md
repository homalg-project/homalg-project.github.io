...
Open a terminal (in Linux or your Ubuntu installation on Windows) and follow the instructions [here](https://julialang.org/downloads/platform/#cross-platform_installer).
